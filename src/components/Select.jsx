...
const SelectScrollButton = forwardRef(({ className, direction, ...props }, ref) => (
...
const SelectContent = forwardRef(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "relative z-50 w-full overflow-hidden rounded-md border",
...
const SelectItem = forwardRef(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none focus:bg-amber-200 focus:text-amber-900 hover:bg-amber-100",
      className
    )}
    {...props}
  >
